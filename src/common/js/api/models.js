...
const baseUrl = "http://free.svipss.top:21199"
//#endif
// 获取作品列表
...
export const getTrendSecondComment = (requestConfig) =>
	apiResquest(`${baseUrl}/dynamic/${requestConfig.urlParam.trendId}/comment/${requestConfig.urlParam.commentId}/comment`, { method: "GET", requestConfig });
//获取我的私信列表
