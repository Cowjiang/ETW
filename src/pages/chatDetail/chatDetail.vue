    ...
    return {
      ...
      messageRecordsTemp: [
        ...
        },
        {
          ...
          isPhoto: false,
          content:
            "Mixue ice cream & tea I love you you love me Mixue ice cream & tea",
        ...
        },
        {
          ...
          isPhoto: false,
          content:
            "蜜雪冰城甜蜜蜜你爱我呀我爱你你爱我我爱你蜜雪冰城甜蜜蜜你爱我我爱你蜜雪冰城甜蜜蜜你爱我我爱你蜜雪冰城甜蜜蜜你爱我我爱你蜜雪冰城甜蜜蜜",
        ...
        success: (res) => {
          if (res.tapIndex === 0) {
            uni.setClipboardData({
              data: this.messageRecords[
                parseInt(e.target.dataset.name.replace("message", ""))
              ].content,
              success: () => {},
            });
          } else {
